        ...
        ?>
            <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav ">
                        <li class="nav-item">
                            <a class="nav-link active" href="Admin_Home.php">Αρχική</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row">
                        <div class="col-7">
                            ...
                            <?php
                                    ...
                                    $query = sprintf("SELECT DISTINCT sensor.ID_DEVICE, sensor.LONGITUDE,sensor.LATITUDE ,person.SURNAME,person.NAME FROM  person_has_sensor
                    ...
                    <form action="Admin_Home.php" method="POST">
                        ...
                        <select  id="sensors" name="sensors" style="height:4%; width:20%;">
                            ...
                            <?php
                                ...
                                WHERE ID_DEVICE IN (SELECT `ID_DEV` FROM `person_has_sensor` )";
            ...
            <?php
                ...
                {  
                    ...
                    $query = sprintf("SELECT * FROM (SELECT ID_V, DEVICE, `HUMIDITY_AIR`, `TEMPERATURE_AIR`, `MOISTURE_GRD`, `TEMPERATURE_GRD_50CM`, 
                            `TEMPERATURE_GRD_100CM`, `LEAF_WEATNESS`, `PHOTOSENSOR` ,`V_Timestamp` FROM `s_values` 
                            WHERE DEVICE = (SELECT MIN(ID_DEV) FROM person_has_sensor  ) ORDER BY ID_V DESC LIMIT 10) var1 ORDER BY ID_V ASC ;");
                    
                    $query3="SELECT MIN(ID_DEV) AS DEV FROM person_has_sensor ";
           ...
           <script type="text/javascript" >
            ...
            <script>
              ...
              //Add the Google Hybrid layer
               ...
               for (var i=0;i< Object.keys(meta).length; i++ ){
                 L.marker([parseFloat(meta[i]["lon"]),parseFloat(meta[i]["lat"])]).bindPopup(meta[i]["id"]+ " "+meta[i]["nam"]+" "+meta[i]["sur"]).addTo(map).openPopup(); 
               }
            ...
            <script type="text/javascript">
                ...
                function refreshTable(){
                    $('#tablesensor').load('get_table_sensors_Admin.php', function(){
